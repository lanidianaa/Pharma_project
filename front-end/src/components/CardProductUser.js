...
const CardProductUser = ({ name, price, id, img, qty, pricePerGram }) => {
	...
	return (
		<div class="flex-shrink-0 bg-blue-200m-6 relative overflow-hidden bg-gray-50 rounded-lg max-w-xs w-48 sm:w-14 md:w-28 lg:w-48 shadow-lg m-5">
			<svg
			...
			<Link to={`product/detail?id=${id}`}>
				<div class="relative pt-10 px-10 flex items-center justify-center">
					<div
						class="block absolute w-48 h-48 sm:w-14 sm:h-14 md:w-28 lg:w-48 bottom-0 left-0 -mb-24 ml-3"
						style={{
